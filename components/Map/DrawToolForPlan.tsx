...
export default function DrawingToolBar({ geoJsonData, isSavingRef, setLayers, FeatureGroupRef }: any){
                    ...
                    popupInput.addEventListener('change', async (e) => {
                        ...
                        FeatureGroupRef.current.eachLayer(layer => {
                            if (layer.feature &&  layer.feature.properties && layer.feature.properties.uuid === feature.properties.uuid){
                                layer.feature.properties.descript = (e.target as HTMLInputElement).value
                            }
                        })
    ...
    async function handleCreate(e: L.DrawEvents.Created){
